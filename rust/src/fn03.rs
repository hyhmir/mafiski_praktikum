...
#[pyfunction]
pub fn q_4(n: usize, tajp: String) -> PyResult<Vec<Vec<f64>>> {
    if tajp == "1" {
        let q = gen_q(n);
...
#[pyfunction]
pub fn matsum(a: Vec<Vec<f64>>, b: Vec<Vec<f64>>) -> PyResult<Vec<Vec<f64>>> {
    let n = b[0].len();
    let mut m = vec![vec![0.0; n]; n];
    for i in 0..n {
        for j in 0..n {
...
#[pyfunction]
pub fn mul(a: f64, b: Vec<Vec<f64>>) -> PyResult<Vec<Vec<f64>>> {
    let n = b[0].len();
    let mut m = vec![vec![0.0; n]; n];
    for i in 0..n {
        for j in 0..n {
...
#[pyfunction]
pub fn harm(n: usize) -> PyResult<Vec<Vec<f64>>> {
    let mut m = vec![vec![0.0; n]; n];
    for i in 0..n {
        m[i][i] = i as f64 + 0.5
    }
...
#[pyfunction]
pub fn echo_copy(matrix: Vec<Vec<f64>>) -> PyResult<Vec<Vec<f64>>> {
...
#[pyfunction]
pub fn power_method(matrix: Vec<Vec<f64>>, max_iters: usize, tol: f64) -> PyResult<(f64, Vec<f64>)> {
    let n = matrix.len();
...
#[pyfunction]
pub fn jacobi_eigen(matrix: Vec<Vec<f64>>, max_iters: usize, tol: f64) -> PyResult<(Vec<f64>, Vec<Vec<f64>>)> {
    let n = matrix.len();
...
#[pyfunction]
pub fn lanczos(matrix: Vec<Vec<f64>>, k: usize) -> PyResult<(Vec<f64>, Vec<Vec<f64>>)> {
    let n = matrix.len();
...
#[pyfunction]
pub fn qr_eigen(matrix: Vec<Vec<f64>>, max_iters: usize, tol: f64) -> PyResult<(Vec<f64>, Vec<Vec<f64>>)> {
...
#[pyfunction]
pub fn transposey(a: Vec<Vec<f64>>) -> PyResult<Vec<Vec<f64>>> {
    let n = a.len();
    let m = a[0].len();
    let mut t = vec![vec![0.0; n]; m];
    for i in 0..n {
...
#[pyfunction]
pub fn dodatna(n: usize) -> PyResult<Vec<Vec<f64>>> {
    let mut m = vec![vec![0.0; n]; n];
    for i in 0..n {
        m[i][i] = i as f64 + 0.5
    }
